...
console.log(
  hasSubpattern(
    "qwertyuiopasdfghjklzxcvbnmmnbvcxzlkjhgfdsapoiuytrewqqazxswedcvfrtgbnhyujmkiolpqwertyuiopasdfghjklzxcvbnmmnbvcxzlkjhgfdsapoiuytrewqqazxswedcvfrtgbnhyujmkiolp"
  )
); //cannot be entirely repr`oduced repeating a pattern
